var BEMHTML = (function(exports) {
        ...
        if (__t === "content") {
            ...
            if (__t === "b-page") {
                ...
                if (this.elem === "core") {
                    ...
                    }, __r35 = $1.call(this), this._mode = __r33, this.ctx = __r34, "", __r35;
                    return;
                } else {
                    return $136.call(this);
                }
    ...
    function $5() {
        {
            ...
            if (this.ctx.h1) {
                c[0].content.content.push(this.ctx.h1);
            } else {
                undefined;
            }
            undefined;
    ...
    function $23() {
        var __r52, __r53, __r54, __r55;
        {
            var ctx = this.ctx, props = [ "title", "target" ], p = typeof ctx.url, a = {
                href: p === "undefined" || p === "string" ? ctx.url : (p = [], "", __r52 = this._buf, this._buf = p, __r53 = this._mode, this._mode = "", __r54 = this.ctx, this.ctx = ctx.url, __r55 = $1.call(this), this._buf = __r52, this._mode = __r53, this.ctx = __r54, "", __r55, p.join(""))
            };
            while (p = props.pop()) {
                ctx[p] && (a[p] = ctx[p]);
            }
    ...
    function $157() {
        var __r18, __r8, __r12, __r13, __r14, __r15, __r16, __r17, __r9, __r19, __r22, __r23, __r24, __r25, __r26, __r27;
        {
            ...
            tag = ("", __r8 = this._mode, this._mode = "tag", __r9 = $1.call(this), this._mode = __r8, "", __r9);
            typeof tag != "undefined" || (tag = v.tag);
            typeof tag != "undefined" || (tag = "div");
            if (tag) {
                var jsParams, js;
                if (this.block && v.js !== false) {
                    js = ("", __r12 = this._mode, this._mode = "js", __r13 = $1.call(this), this._mode = __r12, "", __r13);
                ...
                undefined;
                buf.push("<", tag);
                var isBEM = ("", __r14 = this._mode, this._mode = "bem", __r15 = $1.call(this), this._mode = __r14, "", __r15);
                typeof isBEM != "undefined" || (isBEM = typeof v.bem != "undefined" ? v.bem : v.block || v.elem);
                var cls = ("", __r16 = this._mode, this._mode = "cls", __r17 = $1.call(this), this._mode = __r16, "", __r17);
                cls || (cls = v.cls);
                ...
                if (isBEM || cls) {
                    ...
                    if (isBEM) {
                        ...
                        var mix = ("", __r18 = this._mode, this._mode = "mix", __r19 = $1.call(this), this._mode = __r18, "", __r19);
                ...
                undefined;
                if (jsParams) {
                    var jsAttr = ("", __r22 = this._mode, this._mode = "jsAttr", __r23 = $1.call(this), this._mode = __r22, "", __r23);
                    buf.push(" ", jsAttr || "onclick", '="return ', this._.attrEscape(JSON.stringify(jsParams)), '"');
                } else {
                    undefined;
                }
                undefined;
                var attrs = ("", __r24 = this._mode, this._mode = "attrs", __r25 = $1.call(this), this._mode = __r24, "", __r25);
            ...
            if (this._.isShortTag(tag)) {
                ...
                tag && buf.push(">");
                var content = ("", __r26 = this._mode, this._mode = "content", __r27 = $1.call(this), this._mode = __r26, "", __r27);
